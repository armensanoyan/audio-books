...
for your iPad?” I am optimistically asking a hypothetical question and you know what I want you to say.
...
can’t remember the last time you cracked open a paper, but it sounds like traditional PR might be a viable option for reaching customers like your mom.
...
Consider how much easier our lives would have been if we’d understood the motivation behind the request. Instead of enabling the exploration and export of all campaign data, we could have just always exported the few high-level numbers a big brand manager would be interested in. And instead of a selfserve dashboard, we could set up a little scheduler to send it to them every Friday. In fact, we didn’t even need to build a dashboard at all. And instead of coding up a layout and branding system for the reports, we could have had an intern hand-build them each week. All wasted because I didn’t ask the right question. I sure wish I had those 3 months back!
...
•	How would that fit into your day? Questions to dig into emotional signals:
...
doesn’t give you any new insight, but can still be useful at the start of a conversation to figure out what sort of person you’re talking to so you can ask relevant follow-ups. Them: “Not really ever.” Well, looks like we’re done here then!
...
If you ask me what my biggest problem with staying fit is, I’ll probably tell you it’s the time cost of going to the gym. But then, if you build me a workout-athome app, I’m going to ignore it. Even though commute time is the biggest problem with getting in shape, the whole area of fitness just isn’t something I care about enough to act on. My #1 fitness problem is still an unimportant one.
...
Versus:
You: What are your big problems right now? If we aren’t sure it’s a mustsolve problem, we start more generic to see if they care at all about the problem category, in which case they’ll mention it.
...
it?” Now that you’ve let me raise the topic, you know it’s on my mind and can more safely zoom in to talk about that specifically. As before, try to figure out what I’m already spending time and money on.
...
Me: “No, I just caught the drama on Hacker News.” I knew the readerpocalypse was coming and didn’t even search around to properly understand the implications and my options. This just isn’t a big deal for me, despite how “annoyed” I claim to be.
...
Them: “Yeah. He kind of sucks though. Most of my work comes through people who just know me from my blog or have seen my other talks.” Hardly a must-solve problem since he has a reliable workaround, but at 
...
IS THE WORST PART OF MY LIFE AND I WILL PAY YOU RIGHT NOW TO FIX IT.” 
...
That being said, some other great people in the field seem to have gotten good results using phone calls. Use whatever serves your purpose. But I will say that you should start in person. It’s too easy to use surveys or phone calls as an excuse to skip the awkwardness of meeting in person rather than as a considered tradeoff.
The advisory flip
...
It turns out that “students” is a broader segment than we initially expected. The first is a PhD student. The second is an ambitious youngling at a prep school. The third is a homeschooling parent who wants to use it with her kid. The fourth is a rural village in the Indian rice belt where all the local kids are selfeducating through the one village computer. The fifth is in Africa, running the app off a shaky cellphone connection. All are “students”. 
...
♀ 	Mentioned a specific person or company ☆ 	Follow-up task
...
•	If a question could be answered via desk research, do that first During the conversation:
•	Frame the conversation
•	Keep it casual
•	Ask good questions which pass The Mom Test
•	Deflect compliments, anchor fluff, and dig beneath signals
•	Take good notes
•	If relevant, press for commitment and next steps After a batch of conversations:
...
By asking good questions, we can fix many flawed ideas before they get us in trouble. But still, sometimes it doesn’t work out. It’s okay. Go to the people who believed in and supported you and thank them. If relevant, apologise. They’ll say something like:
...
•	Taking notes (Chapter 8) The Mom Test:
1.	Talk about their life instead of your idea
2.	Ask about specifics in the past instead of generics or opinions about the future
3.	Talk less and listen more
...
4.	Being too formal
 	“So, first off, thanks for agreeing to this interview. I just have a few questions for you and then I’ll let you get back to your day…”
 	“On a scale of 1 to 5, how much would you say you…”  	“Let’s set up a meeting.”
...
And of course, huge thanks for Mom & Dad for gently planting the entrepreneurial seed with their both encouragement and their own collection of insane startup and/or shipwreck stories. Love you!
`;
